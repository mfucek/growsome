...
function ThirdSection() {
  return (
    <div className="snap-start relative h-screen w-screen flex justify-center mt-[90vh] sm:mt-[200px] lg:mt-0">
      <div className="flex flex-col content-center justify-center mt-[100px] md:mt-[1500px] 2xl:mt-[100px]">
        <div className="text-3xl md:text-6xl font-firaSans font-bold text-[rgb(26,26,26)] mb-[5vh] -mt-[80px] text-center">
          Unser Angebot
        </div>
        <div className="flex flex-col 2xl:flex-row 2xl:justify-around">
          <div className="flex flex-col content-center mx-[5px]">
            <img
              ...
              alt="Image Not Found"
              className="lg:max-w-[450px] lg:min-w-[450px]"
            />
            <div className="text-xl md:text-3xl lg:text-3xl 2xl:text-2xl font-workSans text-[rgb(17,17,17)] mb-4 mt-[3.2vh] max-w-[564px] md:whitespace-nowrap tracking-widest text-center md:ml-[0px]">
              FACHWISSEN & TECHNOLOGIE
            </div>
            <div className="md:text-[21px] lg:text-[28px] 2xl:text-[20px] font-firaSans text-[rgb(68,68,68)] mb-4 mt-[3.5vh] max-w-[90vw] mx-[5px] md:max-w-[564px] lg:max-w-[420px] md:mx-[18px]">
