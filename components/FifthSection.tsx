...
function FifthSection() {
  return (
    <div className="snap-start relative h-screen flex flex-col items-center ">
      <div className="font-firaSans text-[rgb(17,17,17)] font-bold md:mb-[20px] mt-[700px] sm:mt-[1900px] md:mt-[1100px] lg:mt-[2600px] 2xl:mt-[0px] text-[48px] md:text-[64px]">
        Ihre Partner
      </div>
      <div className="flex flex-col 2xl:flex-row items-center justify-center">
        <div className="flex flex-col items-center content-around">
          ...
          <div className="text-[24px] md:text-[24px] font-firaSans tracking-wide mt-[20px] max-w-[630px] mx-[20px]">
        ...
        <div className="flex flex-col items-center mt-[0px]">
          ...
          <div className="text-[24px] md:text-[24px] font-firaSans tracking-wide mt-[20px] max-w-[630px] mx-[20px] 2xl:ml-10">
            Software Architekt, Produktentwickler, Organisationsentwickler,
            agile Transformation, 25 Jahre Erfahrung im E-Commerce
          </div>
        </div>
      </div>
      <div className="font-workSans text-[24px] md:text-[24px] mt-[20px] max-w-[90vw] 2xl:max-w-screen">
