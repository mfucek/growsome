  ...
  return (
    <div className="snap-start relative h-screen w-screen flex justify-center content-center">
      <div className="flex flex-col justify-around mt-[945px] sm:mt-[1600px] md:mt-[1900px] lg:mt-[2600px] 2xl:mt-[0px]">
        <div className="flex mt-[20px] 2xl:min-w-[1860px] content-center justify-center">
          <img
            ...
            alt="Image Not Found"
            className="object-fill h-[55vh] 2xl:min-w-[1440px] min-h-[450px] min-w-[900px] hidden lg:block mb-[20px]"
          />
        </div>
        <div className="flex flex-col content-center justify-center 2xl:ml-0 2xl:flex-row">
          ...
          <div className="text-[21px] xl:text-[20px] font-firaSans  text-[rgb(68,68,68)] mb-4 translate=-x-1/2 2xl:translate-x-0 2xl:ml-[200px] min-w-[80vw] sm:min-w-[0vw] max-w-[70vw] 2xl:max-w-[800px] 2xl:min-w-[800x]">
